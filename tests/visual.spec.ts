...
const captures = [
  ...
  { route: '/nutrition', name: '04_saisie_nutrition', width: 1487, height: 1058, ready: '.food-diary-layout' },
  ...
  { route: '/objectifs', name: '08_objectifs', width: 1487, height: 1058, ready: '.objective-config' },
]
